...
# v1.1 / 2021-03-14 / Jan Schumacher / mail@jschumacher.info
# https://jschumacher.info/2021/03/up-to-date-filebeat-for-32bit-raspbian-armhf/
#
# v1.0 to 1.1: Removing realtive paths, fixing dpkg-deb repackage method, updating help text, typos
...
setup_local_go() {
  ...
  GO_DL_PATH_URL="$(wget -qO- $GO_DL_SITE/dl/ | grep -oP '\/dl\/go([0-9\.]+)\.linux-amd64\.tar\.gz' | head -n 1)" 
